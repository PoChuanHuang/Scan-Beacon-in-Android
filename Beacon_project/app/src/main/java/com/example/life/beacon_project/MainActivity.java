...
//        mDetector = new GestureDetectorCompat(this, new MyGestureListener());
        ...
        request_permissions();//檢查權限的函式

        if(mBluetoothAdapter != null && mBluetoothAdapter.isEnabled()&&ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                == PackageManager.PERMISSION_GRANTED
                &&ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                == PackageManager.PERMISSION_GRANTED)//權限是否都開了，如果是
        {
